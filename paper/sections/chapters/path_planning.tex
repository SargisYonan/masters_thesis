...
\begin{figure}[htb!]
    \centering
    \includegraphics[width=0.8\linewidth]{figures/sim_figures/nbv_40p_20x20_sf_4_seed_2.png}
    \captionsetup{skip=0.25\baselineskip}
    \ssp
    \caption{Greedy Next-Best-View Method limited to scanning a size $20\times 20$ field up to $40\%$ percent. The actual field (top left), predicted field (with error) (top right), variance field (bottom left), and traversed path (bottom right).}
\end{figure}
