...
\part{Background}
\include{sections/chapters/problem_defs}
\include{sections/chapters/previous_work}

\part{Geostatistics}
\include{sections/chapters/geostatistics}

\part{Autonomous Field Exploration Using The Kriging Method}
\include{sections/chapters/characterizing_prediction_confidence}

\include{sections/chapters/constructing_a_field_graph}

\include{sections/chapters/path_planning}

\part{Simulation \& Results}
\include{sections/chapters/simulation_framework}
\include{sections/chapters/results}
